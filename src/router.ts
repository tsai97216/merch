export type RouteName = 'home' | 'collection' | 'statistics' | 'add' | 'shipping' | 'management' | 'settings';
export type Route =
  | { name: RouteName }
  | { name: 'item'; id: string }
  | { name: 'not-found' };
...
const staticRoutes = new Set<RouteName>(['home', 'collection', 'statistics', 'add', 'shipping', 'management', 'settings']);
