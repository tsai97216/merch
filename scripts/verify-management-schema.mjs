...
for (const forbidden of ['createCategoryCode', 'blankItem', 'cleanupOrphanAssets', 'management-cleanup-assets']) if (source.includes(forbidden)) throw new Error(`Management 不得保留已移除的舊功能：${forbidden}`);
