...
- 最新程式修改 commit：`e48e3f49d10d1bc37b31d246c6c463f30b85b9ee`。
...
- 首頁原本的角色排行已重新設計為「角色偏愛」：移除排行用語與名次數字，改以愛心標記呈現角色名稱，不再製造角色之間的比較感。
- 首頁角色偏愛區仍預覽 5 個角色；點入後顯示完整角色清單，同樣不顯示名次與花費數字。
