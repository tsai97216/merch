...
- [x] 修正 repo 版本同步：`package.json`、`public/data/version.json` 與 Worker source version 已更新至 `1.109.800`，且版本驗證器現在會三方檢查。
...
- [ ] 正式 Worker 尚需部署 `1.109.800`，並重新驗收新增／替換圖片，確認正式環境不再使用舊 Worker。
